...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:DY.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Sim/SimDY1/python/MyHadronizer.py nevts:10'),

...
# with command line options: --python_filename nanoaod.py --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:nanoaod.root --conditions 106X_mcRun2_asymptotic_v17 --step NANO --filein file:reco.root --era Run2_2016,run2_nanoAOD_106Xv2 --no_exec --mc -n 5

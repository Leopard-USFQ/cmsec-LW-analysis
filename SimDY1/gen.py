...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-02838-fragment.py --python_filename HIG-RunIISummer20UL16wmLHEGEN-02838_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:HIG-RunIISummer20UL16wmLHEGEN-02838.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 9600
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-02838-fragment.py nevts:9600'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGEN-02838.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGEN-02838_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/madgraph/V5_2.6.5/dyellell1j_mll10to50_5f_LO_MLM/v1/dyellell1j_mll10to50_5f_LO_MLM_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
    generateConcurrently = cms.untracked.bool(True),
    nEvents = cms.untracked.uint32(9600),

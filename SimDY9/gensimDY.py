...
# with command line options: Stable/SimDY8/python/DYHad.py --mc --beamspot Realistic25ns13TeV2016Collision --eventcontent=RAWSIM --datatier=GEN-SIM --conditions 106X_mcRun2_asymptotic_v17 --step=GEN,SIM --python_filename=gensimDY.py --no_exec --number=100 --fileout=gensimDY.root --customise Configuration/DataProcessing/Utils.addMonitoring --filein file:../../Data/LHE/DYToLL.lhe --filetype LHE
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:../../Data/LHE/DYtoLL.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Stable/SimDY8/python/DYHad.py nevts:1000'),

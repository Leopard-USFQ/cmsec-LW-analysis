...
# with command line options: --python_filename D2R.py --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI --fileout file:D2R.root --pileup_input dbs:/cvmfs/cms-opendata-conddb.cern.ch/106X_mcRun2_asymptotic_v17/PREMIX --conditions 106X_mcRun2_asymptotic_v17 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --geometry DB:Extended --filein file:gensimLW.root --datamix PreMix --era Run2_2016 --runUnscheduled --no_exec --mc -n 10
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:D2R.root'),

...
# with command line options: --python_filename HLT.py --eventcontent RAWSIM --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --fileout file:HLT.root --conditions 106X_mcRun2_asymptotic_v17 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step DIGI,L1,DIGI2RAW,HLT:GRun --geometry DB:Extended --filein file:gensimLW.root --era Run2_2016 --no_exec --mc -n 10

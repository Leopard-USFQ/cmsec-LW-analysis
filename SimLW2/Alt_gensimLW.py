...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:JJSJ_Addflighttime.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SimLW/Sim2/python/myHadronizer.py nevts:1000'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        pythiaMyParameters = cms.vstring(
            '556:new = lwe- lwe+ 2 -3 0 200.0 7.287748e-12 200.0 200.0 2.70948e-02', 
            '556:isResonance=off', 
            '556:isVisible=off', 

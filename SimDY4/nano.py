...
# with command line options: --python_filename nano.py --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:nano.root --conditions 106X_mcRun2_asymptotic_v17 --step NANO --filein file:pat.root --era Run2_2016,run2_nanoAOD_106Xv2 --no_exec --mc -n 100

...
# with command line options: --filein file:pat.root --fileout file:NanoAOD.root --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_v17 --step NANO --geometry DB:Extended --era Run2_2016,run2_nanoAOD_94X2016 --python_filename nanoAOD_cfg.py --no_exec --customise_commands process.nanoAOD_step *= process.nanoSequenceMC -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:pat_v2.root'),
...
process.nanoAOD_step *= process.nanoSequenceMC

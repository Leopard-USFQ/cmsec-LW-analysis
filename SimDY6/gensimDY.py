...
# with command line options: Sim/SimDY6/python/DYHad.py --python_filename=gensimDY.py --eventcontent=RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier=GEN-SIM --fileout=gensimDY.root --conditions 106X_mcRun2_asymptotic_v17 --beamspot Realistic25ns13TeV2016Collision --step=GEN,SIM --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Sim/SimDY6/python/DYHad.py nevts:1000'),
